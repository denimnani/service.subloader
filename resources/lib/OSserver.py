...
import os, sys, xbmc, xmlrpclib
from utils import name, version, setting, boolsetting




OpenSubtitles = xmlrpclib.Server('http://api.opensubtitles.org/xml-rpc', verbose=0)
